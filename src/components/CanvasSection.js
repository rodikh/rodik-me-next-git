...
export default class CanvasSection extends React.Component {
    ...
    demoTypes = {
        ...
        'particles': {
            up: (canvas, options) => {
                const exploder = new ParticleExploder(canvas, canvas, {gravity: 0.02, color: '0,0,0'});
                const emitter1 = new ParticleEmitter({x: 50, y: 50}, {x:3, y:0}, canvas, {color: '0,0,0', isDecaying: false, fps: 30, gravity: 0.02});
